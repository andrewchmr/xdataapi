...
class TweetBatch:
    ...
    Attributes:
        ...
        request_id (UUID):
        data (list[Tweet] | Unset): Found tweets
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.tweet import Tweet  # noqa: PLC0415
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = Tweet.from_dict(data_item_data)
        ...
        tweet_batch.additional_properties = d
        return tweet_batch
